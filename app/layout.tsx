              ...
              "@graph": [
                {
                  ...
                  areaServed: [
                    { "@type": "City", name: "Caria" },
                    { "@type": "City", name: "Unhais da Serra" },
                    { "@type": "City", name: "Peso" },
                    { "@type": "City", name: "Belmonte" },
                    { "@type": "City", name: "Covilhã" },
                    { "@type": "City", name: "Fundão" },
                    { "@type": "City", name: "Castelo Branco" },
                    { "@type": "City", name: "Covilhã" },
                    { "@type": "AdministrativeArea", name: "Belmonte" },
                    { "@type": "AdministrativeArea", name: "Fundão" },
                    { "@type": "AdministrativeArea", name: "Covilhã" },
                    { "@type": "AdministrativeArea", name: "Castelo Branco" },
                    "Serra da Estrela", "Beira Interior", "Cova da Beira",
                  ],
                  sameAs: [
                    "https://www.facebook.com/clinicacariense",
                    "https://www.instagram.com/clinicacariense",
                  ],
                },
              ],
            }),
