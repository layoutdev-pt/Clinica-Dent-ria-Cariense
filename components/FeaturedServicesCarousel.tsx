...
export default function FeaturedServicesCarousel({ items }: { items: Service[] }) {
  ...
  // slots: -1 (left peek), 0 (center), +1 (right peek)
  const slots = [-1, 0, 1];
  ...
  return (
    <div>
      <style>{`
        ...
        .anim-text-right { animation: textSlideRight 0.48s cubic-bezier(0.34,1.56,0.64,1) forwards; }
        .anim-text-left  { animation: textSlideLeft  0.48s cubic-bezier(0.34,1.56,0.64,1) forwards; }
        .anim-photo      { animation: photoFadeIn    0.45s cubic-bezier(0.34,1.56,0.64,1) forwards; }
      `}</style>
      ...
      <div className="hidden md:block">
        ...
        >
          ...
          <button
            ...
            className="absolute left-0 z-20 w-11 h-11 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
            style={{ background: "white", border: "1.5px solid #D5E4EE", color: "#0D1E2C", boxShadow: "0 4px 16px rgba(13,30,44,0.1)" }}
          ...
          <button
            ...
            className="absolute right-0 z-20 w-11 h-11 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
          ...
          >
            ...
            {(() => {
              ...
              return (
                ...
                >
                  <Image src={items[idx].img} alt={items[idx].title} fill className="object-cover" sizes="200px" />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#F0F6FA]/60 to-transparent" />
                </div>
              );
            })()}
            ...
            >
              {/* Center photo */}
              <div
                key={`center-${contentKey}`}
                className={`flex-shrink-0 relative rounded-[24px] overflow-hidden ${prev !== null ? "anim-photo" : ""}`}
                style={{
                  width: 320,
                  height: 480,
                  boxShadow: "0 24px 64px rgba(13,30,44,0.18), 0 0 0 1.5px rgba(28,159,214,0.2)",
                }}
              >
                <Image
                  src={current.img}
              ...
              <div
                key={`text-${contentKey}`}
                className={`flex-1 ${prev !== null ? (dir === 1 ? "anim-text-right" : "anim-text-left") : ""}`}
              >
                {/* Step indicator */}
                ...
                <p className="text-[#5E7387] text-sm leading-relaxed mb-7" style={{ maxWidth: 260 }}>
                  {current.desc}
                </p>

                <a
                  href="/contactos"
                  className="inline-flex items-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-full transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                    background: "#1C9FD6",
                    color: "white",
                    boxShadow: "0 4px 20px rgba(28,159,214,0.35)",
                  }}
            ...
            {(() => {
              ...
              return (
                ...
                >
                  <Image src={items[idx].img} alt={items[idx].title} fill className="object-cover" sizes="200px" />
                  <div className="absolute inset-0 bg-gradient-to-l from-[#F0F6FA]/60 to-transparent" />
                </div>
              );
            })()}
          </div>
      ...
      <div className="md:hidden">
        ...
        >
          <Image
            ...
            alt={current.title}
            fill
            className="object-cover anim-photo"
            sizes="100vw"
            priority
          />
        ...
        <div
          ...
          className={`mb-5 ${prev !== null ? (dir === 1 ? "anim-text-right" : "anim-text-left") : ""}`}
        >
