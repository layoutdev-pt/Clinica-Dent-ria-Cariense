          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a
                ...
                className="mt-2 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-[#1C9FD6]/40 bg-[#1C9FD6]/10 text-[#1C9FD6] text-xs font-semibold hover:bg-[#1C9FD6] hover:text-white hover:border-[#1C9FD6] transition-all duration-200"
              >
